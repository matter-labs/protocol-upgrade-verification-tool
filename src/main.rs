...
// Head of era-contracts branch `vb-v29.5-verifier-keys` (PR #2337): era-contracts
// `main` (fd129fe7) + the regenerated v29.5 verification keys ported to the
// pre-v31 layout (L1VerifierFflonk/L1VerifierPlonk), with AllContractsHashes.json
// regenerated by CI. This is the exact source the v29.5 mainnet verifier upgrade
// contracts were built and deployed from.
const DEFAULT_CONTRACTS_COMMIT: &str = "71cd02a96bd7f0ca12ec70aed601ed2d643ccc92";
